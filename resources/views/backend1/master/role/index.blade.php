        ...
        $(document).ready(function() {
            var table = $('#inventory-table').DataTable({
                ...
                columns: [
                    ...
                    //                             <a href="#" onclick="openEditModal(${row.id}, '${row.name}' " class="cursor-pointer flex items-center p-2 transition duration-300 ease-in-out rounded-md hover:bg-slate-200/60 dark:bg-darkmode-600 dark:hover:bg-darkmode-400 dropdown-item">
                            ...
                            return `
                                <div class="flex items-center justify-center">
                                    <div class="dropdown relative h-5">
                                        ...
                                        <div class="dropdown-menu absolute z-[9999] hidden">
                                            <div class="dropdown-content rounded-md border-transparent bg-white p-2 shadow-[0px_3px_10px_#00000017] dark:border-transparent dark:bg-darkmode-600 w-40">
                                                <a href="#" onclick="openEditModal(${row.id}, '${row.name}', '${row.email}')" class="cursor-pointer flex items-center p-2 transition duration-300 ease-in-out rounded-md hover:bg-slate-200/60 dark:bg-darkmode-600 dark:hover:bg-darkmode-400 dropdown-item">
                                                    <i class="fas fa-edit mr-2"></i> Edit
                                                </a>
                                                <a href="#" class="cursor-pointer flex items-center p-2 transition duration-300 ease-in-out rounded-md hover:bg-slate-200/60 dark:bg-darkmode-600 dark:hover:bg-darkmode-400 dropdown-item text-danger delete-btn" data-id="${row.id}">
                                                    <i class="fas fa-trash-alt mr-2"></i> Delete
...
<script>
    ...
    document.getElementById('edit-form').action = `/roles/update/${id}`;
