...
@section('title', 'Trust UC - Supplier')
@section('br2', 'Supplier')
@push('style')
@endpush
@section('main')
                            ...
                            <form action="{{ route('store.supplier') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div data-tw-merge class="p-5 grid grid-cols-12 gap-4 gap-y-3">
                                    ...
                                    <div class="col-span-12 sm:col-span-12">
                                        ...
                                        <input data-tw-merge id="modal-form-1" type="number" name="no_hp" placeholder="No Hp" class="disabled:bg-slate-100 disabled:cursor-not-allowed dark:disabled:bg-darkmode-800/50 dark:disabled:border-transparent [&[readonly]]:bg-slate-100 [&[readonly]]:cursor-not-allowed [&[readonly]]:dark:bg-darkmode-800/50 [&[readonly]]:dark:border-transparent transition duration-200 ease-in-out w-full text-sm border-slate-200 shadow-sm rounded-md placeholder:text-slate-400/90 focus:ring-4 focus:ring-primary focus:ring-opacity-20 focus:border-primary focus:border-opacity-40 dark:bg-darkmode-800 dark:border-transparent dark:focus:ring-slate-700 dark:focus:ring-opacity-50 dark:placeholder:text-slate-500/80 [&[type='file']]:border file:mr-4 file:py-2 file:px-4 file:rounded-l-md file:border-0 file:border-r-[1px] file:border-slate-100/10 file:text-sm file:font-semibold file:bg-slate-100 file:text-slate-500/70 hover:file:bg-200 group-[.form-inline]:flex-1 group-[.input-group]:rounded-none group-[.input-group]:[&:not(:first-child)]:border-l-transparent group-[.input-group]:first:rounded-l group-[.input-group]:last:rounded-r group-[.input-group]:z-10">
                                    </div>
                                    <div class="col-span-12 sm:col-span-12">
                                        <label data-tw-merge for="modal-form-1" class="inline-block mb-2 group-[.form-inline]:mb-2 group-[.form-inline]:sm:mb-0 group-[.form-inline]:sm:mr-5 group-[.form-inline]:sm:text-right">
                                            Vendor
                                        </label>
                                        <input data-tw-merge id="modal-form-1" type="text" name="vendor" placeholder="Vendor" class="disabled:bg-slate-100 disabled:cursor-not-allowed dark:disabled:bg-darkmode-800/50 dark:disabled:border-transparent [&[readonly]]:bg-slate-100 [&[readonly]]:cursor-not-allowed [&[readonly]]:dark:bg-darkmode-800/50 [&[readonly]]:dark:border-transparent transition duration-200 ease-in-out w-full text-sm border-slate-200 shadow-sm rounded-md placeholder:text-slate-400/90 focus:ring-4 focus:ring-primary focus:ring-opacity-20 focus:border-primary focus:border-opacity-40 dark:bg-darkmode-800 dark:border-transparent dark:focus:ring-slate-700 dark:focus:ring-opacity-50 dark:placeholder:text-slate-500/80 [&[type='file']]:border file:mr-4 file:py-2 file:px-4 file:rounded-l-md file:border-0 file:border-r-[1px] file:border-slate-100/10 file:text-sm file:font-semibold file:bg-slate-100 file:text-slate-500/70 hover:file:bg-200 group-[.form-inline]:flex-1 group-[.input-group]:rounded-none group-[.input-group]:[&:not(:first-child)]:border-l-transparent group-[.input-group]:first:rounded-l group-[.input-group]:last:rounded-r group-[.input-group]:z-10">
                                    </div>
                                </div>
                        ...
                        <div class="modal-content w-[90%] mx-auto bg-white relative rounded-md shadow-md transition-[margin-top,transform] duration-[0.4s,0.3s] mt-16 dark:bg-darkmode-600 sm:w-[460px]">
                            ...
                            <form id="edit-form" action="" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="p-5 grid grid-cols-12 gap-4 gap-y-3">
                                    <div class="col-span-12 sm:col-span-12">
                                        <label for="edit-name" class="inline-block mb-2">Nama Supplier</label>
                                        <input id="edit-name" name="nama" type="text" class="w-full text-sm border-slate-200 shadow-sm rounded-md">
                                    </div>
                                    <div class="col-span-12 sm:col-span-12">
                                        <label for="edit-no_hp" class="inline-block mb-2">No Hp</label>
                                        <input id="edit-no_hp" name="no_hp" type="number" class="w-full text-sm border-slate-200 shadow-sm rounded-md">
                                    </div>
                                    <div class="col-span-12 sm:col-span-12">
                                        <label for="edit-vendor" class="inline-block mb-2">Vendor</label>
                                        <input id="edit-vendor" name="vendor" type="text" class="w-full text-sm border-slate-200 shadow-sm rounded-md">
                                    </div>
                                </div>
                                <div class="px-5 py-3 text-right border-t border-slate-200/60 dark:border-darkmode-400">
                                    ...
                                    <div class="dropdown relative h-5">
                                        ...
                                        <div class="dropdown-menu absolute z-[9999] hidden">
                                            <div class="dropdown-content rounded-md border-transparent bg-white p-2 shadow-[0px_3px_10px_#00000017] dark:border-transparent dark:bg-darkmode-600 w-40">
                                                <a href="#" onclick="openEditModal(${row.id}, '${row.nama}','${row.no_hp}','${row.vendor}')" class="cursor-pointer flex items-center p-2 transition duration-300 ease-in-out rounded-md hover:bg-slate-200/60 dark:bg-darkmode-600 dark:hover:bg-darkmode-400 dropdown-item">
...
<script>
    function openEditModal(id, nama,no_hp,vendor) {
    ...
    document.getElementById('edit-form').action = `/supplier/update/${id}`;
